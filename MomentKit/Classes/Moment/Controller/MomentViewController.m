...
- (void)initTestInfo
{
    ...
    for (int i = 0;  i < 4; i ++)  {
        ...
        if (i == 0) {
            ...
            moment.text = @"天界大乱，九州屠戮，18107891687当初被推下地狱的她已经浴火归来，https://www.baidu.com 😭😭剑指仙界'你们杀了他，我便覆了你的天，毁了你的界，永世不得超生又如何！'👍👍 @娄艺潇 ";
            moment.fileCount = arc4random()%10;
        } else if (i == 2) {
            moment.fileCount = 9;
        } else {
            moment.text = @"天界大乱，九州屠戮，CheeryLau@126.com 当初被推下地狱的她已经浴火归来，#生活大爆炸# 😭😭剑指仙界'你们杀了他，我便覆了你的天，毁了你的界，永世不得超生又如何！'👍👍 @娄艺潇 ";
            moment.fileCount = arc4random()%10;
            moment.commentList = nil;
        }
